...
export function Aboutscreen() {
    const pageTitle =
        "À propos de Cousu Mouche – Perrine, créatrice de couture artisanale pour bébé & enfant";
    const pageDescription =
        "Découvrez l’histoire de Perrine, créatrice de CousuMouche : atelier de couture artisanale qui imagine et confectionne des cadeaux de naissance, accessoires et articles de puériculture faits main pour bébé et enfant, depuis l’Occitanie.";

    const structuredData = {
        "@context": "https://schema.org",
        "@type": "Organization",
        name: "CousuMouche",
        url: "https://www.cousumouche.fr/",
        description: pageDescription,
        founder: {
            "@type": "Person",
            name: "Perrine",
            jobTitle:
                "Créatrice de couture artisanale pour bébé et enfant",
        },
    };
    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href="https://www.cousumouche.fr/apropos" />
                ...
                <div className=" block lg:flex lg:flex-wrap w-full lg:justify-center gap-10 lg:content-center mb-20">
                    ...
                    <div className="flex justify-center items-center w-full mx-auto lg:mx-0 mb-6 lg:mb-0 lg:max-w-[600px] min-w-[200px] max-w-[80%]">
                        <p style={{ textAlign: 'justify', fontFamily: 'Poiret', fontWeight: 'bold', lineHeight: 1.78 }}>
                            ...
                            Fille d’une infirmière et d’un entrepreneur, je me suis à mon tour formée pour devenir une blouse blanche. Depuis, je trouve mes inspirations auprès des petits loups de la crèche où j’exerce.<br /><br />
                            Guidée par la passion et l’envie de liberté, je me suis alors lancée dans l’entreprenariat en 2021 en créant « Cousu Mouche ». Et oui, comme le dicton le dit si bien : « des chiens ne font pas des chats », mieux encore « des mouches ne font pas des moustiques »<br /><br />
                            Native d’un pays où le sens de la fête et la chaleur humaine sont ancrés, j’aborde la vie avec joie (même sous la pluie). Aujourd’hui expatriée au sud de la France, en occitanie plus exactement, j’évolue dans un environnement naturel où les champs de tournesols, les lavandes et les vignes ont remplacé les barraques à frites. Vous l’aurez compris, mes créations sont le reflet de mon univers champêtre.<br /><br />
