...
interface IchoiceSangles {
    images: Images[];
    sangleIndex: { [key: string]: number[] };
    setSangleIndex: React.Dispatch<React.SetStateAction<{ [key: string]: number[] }>>;
}
interface IchoiceEtiquettes {
    images: Images[];
    etiquetteIndex: { [key: string]: number[] };
    setEtiquetteIndex: React.Dispatch<React.SetStateAction<{ [key: string]: number[] }>>;
}
...
//     const [imagesSangles, setImagesSangles] = useState<Images[]>([]);
//     const [imagesEtiquettes, setImagesEtiquettes] = useState<Images[]>([]);
//     const [tissusIndexByType, setTissusIndexByType] = useState<{ [type: string]: number[] }>({});
//     const [sangleIndex, setSangleIndex] = useState<{ [key: string]: number[] }>({});
//     const [etiquetteIndex, setEtiquetteIndex] = useState<{ [type: string]: number[] }>({});
...
//                                     {option === 'sangles' &&
//                                         <div>
//                                             <p className="font-poiret font-bold text-lg mt-5 pb-2">Choix de la sangle</p>
//                                             <div className="flex flex-row gap-2">
//                                                 <SangleChoice
//                                                     images={imagesSangles}
//                                                     sangleIndex={sangleIndex}
//                                                     setSangleIndex={setSangleIndex} />
//                                             </div>
//                                         </div>
//                                     }
//                                     {option === 'etiquettes' &&
//                                         <div>
//                                             <p className="font-poiret font-bold text-lg mt-5 pb-2">Choix de l'étiquette</p>
//                                             <div className="flex flex-row gap-2">
//                                                 <EtiquetteChoice
//                                                     images={imagesEtiquettes}
//                                                     etiquetteIndex={etiquetteIndex}
//                                                     setEtiquetteIndex={setEtiquetteIndex}
//                                                 />
//                                             </div>
//                                         </div>
//                                     }
...
// export function SangleChoice(props: IchoiceSangles) {
//     const type = "sangles";

//     const handleClick = (idx: number) => {
//         const current = props.sangleIndex[type] || [];
//         const alreadySelected = current.includes(idx);

//         if (alreadySelected) {
//             props.setSangleIndex((prev) => ({
//                 ...prev,
//                 [type]: [],
//             }));
//         } else {
...
//     return (
//         <div>
//             <p className="font-poiret font-bold mb-2 text-xl">Sangles</p>
//             <div className="flex flex-row gap-2 mb-4 flex-wrap">
//                 {props.images.map((image, idx) => {
//                     const isSelected = Array.isArray(props.sangleIndex[type])
//                         ? props.sangleIndex[type].includes(idx)
//                         : false;
...
//                                 className={
//                                     "w-24 aspect-square overflow-hidden rounded " +
//                                     (isSelected ? "ring-4 ring-[#7E649D]" : "")
//                                 }
//                                 aria-label={`Choisir sangle ${image.name}`}
//                             >
//                                 <img
//                                     src={image.url}
//                                     alt={image.name}
...
// export function EtiquetteChoice(props: IchoiceEtiquettes) {
//     const type = "etiquettes";

//     const handleClick = (idx: number) => {
//         const current = props.etiquetteIndex[type] || [];
//         const alreadySelected = current.includes(idx);

//         if (alreadySelected) {
//             props.setEtiquetteIndex((prev) => ({
//                 ...prev,
//                 [type]: [],
//             }));
//         } else {
...
//             <div className="flex flex-row gap-2 mb-4 flex-wrap">
//                 {props.images.map((image, idx) => {
//                     const isSelected = Array.isArray(props.etiquetteIndex[type])
//                         ? props.etiquetteIndex[type].includes(idx)
//                         : false;
