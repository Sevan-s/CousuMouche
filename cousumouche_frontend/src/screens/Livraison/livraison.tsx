        ...
        <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', marginBottom: 150, marginTop:'2%' }}>
            ...
            <div style={{ width: '50%', textAlign: 'left', marginLeft: '25%', marginTop: '2%' }}>
                ...
                <p style={{ fontFamily: 'Poiret', fontWeight: 'bold' }}>
                    ...
                    <br /><br />
                    • des articles sur commande, confectionnés et  livrés dans un délai compris entre 15 et 30 jours suivant la quantité et le type d’articles commandés et à compter de la réception du paiement.
                    <br /><br />
                ...
                <p style={{ fontFamily: 'Poiret', fontWeight: 'bold' }}>
                    ...
                    <br /><br />
                    • soit par Mondial relais. Vous choisirez au moment de la validation de votre commande votre point relais parmi les points relais proposés dans un rayon proche de votre domicile.
                    <br /><br />
                    Les colis sont également envoyés vers l’UE, la Suisse et le Royaume-uni par lettre suivie internationale ou colissimo internationale.
                    <br /><br />
